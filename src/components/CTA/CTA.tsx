...
const CTA = (props: CTAProps) => {
  ...
  const commonProps = {
    ...
    className: `flex justify-center items-center gap-2 bg-foreground rounded-lg w-full py-3 border border-copy/5 uppercase opacity-70 hover:opacity-100 transition-colors ${className}`,
  };
